...
Learn Volcano Agent SDK through hands-on examples, from simple to advanced. [View all examples on GitHub →](https://github.com/Kong/volcano-agent-sdk/tree/main/examples)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/01-hello-world.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/02-with-tools.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/02b-with-stdio.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/03-streaming.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/04-structured-outputs.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/05-sub-agents.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/06-multi-agent.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/07-patterns.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/08-context.ts)
...
[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/09-observability.ts)
...
**Demonstrates:** OpenAI, Anthropic, Gemini, Mistral, Bedrock, Azure, Vertex integration

[View source →](https://github.com/Kong/volcano-agent-sdk/blob/main/examples/10-providers.ts)
...
See [examples/mcp/README.md](https://github.com/Kong/volcano-agent-sdk/tree/main/examples/mcp) for details.

## Contributing

Have a great use case? [Submit a PR](https://github.com/Kong/volcano-agent-sdk/pulls) with your example!
