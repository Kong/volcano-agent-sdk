...
Volcano Agent SDK supports 100s of models from 7 providers with function calling and MCP integration. Providers can be mixed within a single workflow.
...
```typescript
import { llmOpenAI } from "@volcano/agent";
...
```typescript
import { llmOpenAIResponses } from "@volcano/agent";
...
```typescript
import { llmAnthropic } from "@volcano/agent";
...
```typescript
import { llmMistral } from "@volcano/agent";
...
```typescript
import { llmLlama } from "@volcano/agent";
...
```typescript
import { llmBedrock } from "@volcano/agent";
...
```typescript
import { llmVertexStudio } from "@volcano/agent";
...
```typescript
import { llmAzure } from "@volcano/agent";
...
```typescript
import type { LLMHandle, ToolDefinition, LLMToolResult } from "@volcano/agent";
...
```typescript
import { agent } from "@volcano/agent";
