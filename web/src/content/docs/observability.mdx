...
Volcano Agent SDK uses OpenTelemetry (OTEL), the industry-standard observability framework. Export traces and metrics to any OTEL-compatible backend.
...
Volcano Agent SDK provides detailed metrics to answer critical questions about your AI agents:
