...
Install Volcano Agent SDK - everything you need for OpenAI, Anthropic, Gemini, Mistral, Llama, and Google Vertex providers:
...
Volcano Agent SDK excels in scenarios that require LLM reasoning combined with real-world actions:
...
- [Contribute code or documentation](https://github.com/Kong/volcano-agent-sdk/blob/main/CONTRIBUTING.md)

### ⭐ View on GitHub

- [View on GitHub](https://github.com/Kong/volcano-agent-sdk) - Source code, issues, and discussions
- [NPM Package](https://www.npmjs.com/package/@volcano.dev/agent) - Install via npm and view package details
